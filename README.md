...
<details>
<summary><b>1. Основные фичи питона?</b></summary>
...
<details>
<summary>2. В чем разница между списками (list) и кортежами (tuple)?</summary>
...
<details>
<summary>3. Как в питоне работает трёхместный (тернарный) оператор?</summary>
